...
//          .def("SetE3max", &Operator::SetE3max)
      ...
      py::class_<IMSRGSolver>(m, "IMSRGSolver")
          ...
          .def("EnableStochasticHamiltonianWalkers", &IMSRGSolver::EnableStochasticHamiltonianWalkers)
          .def("EnableStochasticSpawnFlow", &IMSRGSolver::EnableStochasticSpawnFlow)
...
//          .def("GetV3mon_all", &Jacobi3BME::GetV3mon_all)
      ...
      py::module Commutator = m.def_submodule("Commutator", "Commutator namespace");
       ...
       Commutator.def("SetIMSRG2CommutatorBackend", &Commutator::SetIMSRG2CommutatorBackend);
